...
<p align="center"><a href="https://heroku.com/deploy?template=https://github.com/ZauTeKm/Dingdi/tree/Mizo"> <img src="https://img.shields.io/badge/Deploy%20To%20Heroku-blueviolet?style=for-the-badge&logo=heroku" width="210" height="34.45"/></a></p>
...
This file should be placed in your `Dingdi` folder, alongside the `__main__.py` file . 
...
```
from Dingdi.sample_config import Config


class Development(Config):
    OWNER_ID = 1684438752  # my telegram ID
    OWNER_USERNAME = "ZauTeKm"  # my telegram username
