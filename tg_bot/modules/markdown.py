...
`[hyperlink](example.com)` this is used for hyperlinks, and will show as such: [hyperlink](t.me/MizoInFoTel14/24). Make sure not to add any extra spaces between the ] and the ( or it won't be valid markdown.
